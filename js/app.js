angular.module('BookmarkFixer', [
    ...
    .controller('MainController', [
        '$scope', '$http', '$compile', '$templateRequest', '$timeout', '$templateCache',
        function ($_, $http, $compile, $templateGet, $timeout, $cache) {
            ...
            var formatDate = function (time) {
                ...
                , linkToA = function (content, node) {
                    ...
                    var dt = document.createElement('DT')
                        , itemScope = $_.$new(true)
                        ;
                    itemScope.link = link;
                    dt.innerHTML = $cache.get('bookmarkLinkItem.htm');
                    $compile(dt)(itemScope);
                    */
...
<DL>
                                `
                            */
                                , header = $cache.get('bookmarkFileHeader.htm')
